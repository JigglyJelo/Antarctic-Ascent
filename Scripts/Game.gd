...
func _ready() -> void:
	...
	if icicle_scene == null:
		icicle_scene = preload("res://Scenes/Icicle.tscn")
		snowflake_scene = preload("res://Scenes/Snowflake.tscn")
		cloud_scene = preload("res://Scenes/SmallCloud.tscn")
		storm_cloud_scene = preload("res://Scenes/StormCloud.tscn")
		snowman_scene = preload("res://Scenes/Snowman.tscn")
